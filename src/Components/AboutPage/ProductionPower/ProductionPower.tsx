...
const cards = [
  ...
  },
  {
    ...
    icon: "/icons/hexagon-full.svg",
    text: "Унікальний простір, де народжуються вироби з характером. Дільниця оснащена сучасним обладнанням для повного циклу роботи з деревом. Тут технічність поєднується з креативністю, відкриваючи широкі можливості для реалізації найрізноманітніших задумів.",
  },
];
