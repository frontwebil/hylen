      ...
      products: [
        {
          ...
          specs: {
            ...
            rows: [
              ...
              {
                label: "Робоча швидкість обертання ВВП, об/хв",
                values: ["540"],
              },
              ...
              },
              {
                label: "Рама",
                values: [
                  "Жорстка, розбірна, виготовлена з високоміцної сталі S355",
                ],
              },
              {
                label: "Дискові ножі",
    ...
    en: {
      hero: {
        ...
        cards: [
          {
            img: "/osnovy-vrojayy/1.webp",
            subTitle: "Milling and Ridge-Forming Complex",
            id: "kfg",
          },
        ],
      },
      products: [
        {
          ...
          specs: {
            ...
            rows: [
              ...
              {
                label: "Application",
                values: ["Ridge formation for crop planting"],
              },
              ...
              { label: "Hitch type", values: ["Three-point"] },
              {
                ...
                values: ["Film-laying frame lift/lower"],
              },
              {
                label: "Frame",
                values: ["Rigid, modular, made of high-strength S355 steel"],
              },
              {
                label: "Disc knives",
                values: [
                  "Front discs, 500 mm diameter, for cutting soil and crop residues, adjustable",
                ],
              },
              {
                label: "Drive",
                values: [
                  "Tractor PTO drive through driveshaft and gearbox with chain transmission to milling rotor",
                ],
              },
              {
                label: "Support wheels",
                values: [
              ...
              },
              {
                label: "Milling rotor",
                values: [
                  "Modular design with 42 blades, working width 1140 mm",
                ],
              },
              {
                label: "Drip tape",
                values: [
                  "Drip irrigation tape installation option with adjustments",
                ],
              },
              {
                label: "Film layer",
              ...
              {
                label: "Ridge former",
                values: ["Adjustable shield for ridge width control"],
              },
            ],
          },
        },
